...
Future<void> delete_files() async => await Future.delayed(
    Duration(seconds: 2), () => print("Files Deleted")
);

Future<void> copy_files() async => await Future.delayed(
    Duration(seconds: 3), () => print("Files Copied")
);

Future<void> upgrade() async => await Future.delayed(
    Duration(seconds: 4), () => print("OS upgraded ...")
);
